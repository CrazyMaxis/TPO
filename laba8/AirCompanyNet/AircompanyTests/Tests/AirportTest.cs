namespace AircompanyTests.Tests
{
    ...
    public class AirportTest
    {
        ...
        {
            var streamReaderPassengerPlanesJson = new StreamReader("C:\\ALL\\labs\\3k1s\\tpo\\laba8\\AirCompanyNet\\Aircompany\\JSON\\passengerPlanes.json");
            var streamReaderMilitaryPlanesJson = new StreamReader("C:\\ALL\\labs\\3k1s\\tpo\\laba8\\AirCompanyNet\\Aircompany\\JSON\\militaryPlanes.json");
